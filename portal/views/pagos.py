...
class PortalPagoCheckoutView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            print("ERROR CHECKOUT MERCADOPAGO:", repr(e))
            messages.error(
                request,
                f"Ocurrió un problema al generar el enlace de pago: {e}",
            )
            return redirect("portal:pago_detail", pk=pago.pk)
    ...
    def get(self, request, *args, **kwargs):
        messages.warning(
            request,
            "La acción de pago debe enviarse correctamente desde el formulario."
        )
